...
public class MainActivity extends AppCompatActivity {
    ...
    private int wordColIndex, defColIndex;
    ...
    public void nextWord() {
        ...
        if (mData != null) {
            if (mData.moveToNext()) {
                mWordTextView.setText(mData.getString(wordColIndex));
                mDefinitionTextView.setVisibility(View.INVISIBLE);
                mDefinitionTextView.setText(mData.getString(defColIndex));
            } else {
                mData.moveToFirst();
                nextWord();
            }
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            wordColIndex = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_WORD);
            defColIndex = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION);

            mData.moveToFirst();

            String word = mData.getString(wordColIndex);
            String definition = mData.getString(defColIndex);
